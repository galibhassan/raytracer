...
const parseFaceLine = (faceLine) => {
  ...
  ibo_chunk.push(parsedV0.vertIndex, parsedV1.vertIndex, parsedV2.vertIndex);
  textureCoordinates_chunk.push(
    parsedV0.textureCoord,
    parsedV1.textureCoord,
    parsedV2.textureCoord
  );
  vNormals_chunk.push(parsedV0.vNormal, parsedV1.vNormal, parsedV2.vNormal);
  return {
    ibo_chunk,
    textureCoordinates_chunk,
    vNormals_chunk,
  };
};
